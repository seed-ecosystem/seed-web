...
>(({ className, ...props }, ref) => (
  <DialogPrimitive.Overlay
    ref={ref}
    className={cn(
      "fixed inset-0 z-50 bg-black/80  persistence-[state=open]:animate-in persistence-[state=closed]:animate-out persistence-[state=closed]:fade-out-0 persistence-[state=open]:fade-in-0",
      className
    )}
    {...props}
  />
